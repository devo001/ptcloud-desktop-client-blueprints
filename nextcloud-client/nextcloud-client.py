...
class subinfo(info.infoclass):
    def registerOptions(self):
        ...
        self.options.dynamic.registerOption("versionSuffix", "a")
    ...
    def setTargets(self):
        self.svnTargets["stable-4.0"] = "[git]https://github.com/devo001/ptcloud-desktop"

        self.description = "PtCloud Desktop Client"
        self.displayName = "PtCloud"
        self.webpage = "https://www.ptcloud.health"

        self.defaultTarget = "stable-4.0"
...
class Package(CMakePackageBase):
    ...
    def createPackage(self):
        ...
        self.defines["appname"] = "ptcloud"
        self.defines["company"] = "Gerhard vd Westhuizen, Nextcloud GmbH"
        self.applicationExecutable = "ptcloud"
